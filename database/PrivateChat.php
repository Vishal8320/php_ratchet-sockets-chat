...
class PrivateChat
{
	...
	function setChatToken($chat_token)
	{
	...
	{
		$query = "
		SELECT a.user_name as from_user_name, b.user_name as to_user_name, chat_message, token, timestamp, status, to_user_id, from_user_id, from_user_id as f_id 
			FROM chat_message 
	...
	function save_chat()
	{
		...
		INSERT INTO chat_message 
			(to_user_id, from_user_id, chat_message, token, timestamp, status) 
			VALUES (:to_user_id, :from_user_id, :chat_message, :chat_token, :timestamp, :status)
		";
		...
		$statement->bindParam(':chat_token', $this->chat_token);
